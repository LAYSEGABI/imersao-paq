      ...
      <div className="container">
        <div className="jornada-main-container">
          ...
          <div className="jornada-header">
            ...
            <p>
              Cada etapa <strong>prepara você para o próximo desafio.</strong>
            </p>
          </div>
          ...
          <div className="jornada-timeline">
            ...
            <div className="jornada-step">
              ...
              <p>
                Explore o universo da tecnologia e inovação:{" "}
                <span className="text-highlight">amplie sua visão</span> sobre
                carreira e futuro, aprenda{" "}
                <span className="text-highlight">ferramentas digitais</span>{" "}
                essenciais no mercado, conheça suas habilidades e{" "}
            ...
            <div className="jornada-step">
              ...
              <p>
                Escolha a trilha que mais desperta sua curiosidade:{" "}
                <span className="text-highlight">
                  Programação, Design e Criação de jogos
                </span>
                . Dê seus primeiros passos, aprendendo a base e desenvolvendo
            ...
            <div className="jornada-step">
              ...
              <p>
                Aprofunde o conhecimento: tenha{" "}
                <span className="text-highlight">
                  mentorias com profissionais experientes
                </span>{" "}
                da área e valide tudo que aprendeu{" "}
                <span className="text-highlight">através da prática</span>.
              </p>
            </div>
            ...
            <div className="jornada-step">
              ...
              <p>
                Participam de{" "}
                <span className="text-highlight">
                  processos seletivos com empresas de tecnologia
                </span>{" "}
                parceiras e abra caminhos para a inserção no mercado de
                trabalho.
              </p>
            </div>
          </div>
